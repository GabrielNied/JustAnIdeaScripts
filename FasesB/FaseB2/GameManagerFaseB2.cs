...
public class GameManagerFaseB2 : MonoBehaviour
{
    ...
    public AudioClip trilha, destroyPlayer, destroyMeteoro, tiro, propulsor;
    ...
    void Start()
    {
        ...
        barFill = GameObject.Find("Canvas/PlayerFaseB2/ImageFill");
    ...
    void Update()
    {
        ...
        {
            spawner.GetComponent<SpawnerFaseB2>().podeSpawnarNormal = false;
            player.SetActive(false);
            levelFlowManager.gameWon(LevelNumbers.B2);
